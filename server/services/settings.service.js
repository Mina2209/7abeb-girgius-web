...
export const settingsService = {
  async getSingleton() {
    ...
    if (!row) {
      ...
      await prisma.siteSettings.create({
        data: {
          ...
          liturgy_data: DEFAULTS.liturgy_data,
        },
      });
    }
    ...
    const result = {
      ...
      liturgy_data: created?.liturgy_data,
    };
  ...
  async upsert({ default_book_cover, site_sections_visibility, powerpoint_data, liturgy_data }) {
    await prisma.siteSettings.upsert({
      ...
      update: {
        ...
        ...(liturgy_data !== undefined ? { liturgy_data } : {}),
      },
      create: {
        id: 1,
        default_book_cover:
        ...
        liturgy_data: liturgy_data ?? DEFAULTS.liturgy_data,
      },
    });
