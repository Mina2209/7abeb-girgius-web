...
export const fathers: Father[] = [
  {
    ...
    nameEnglish: 'St. Anthony the Great',
  ...
  },
  {
    ...
    nameEnglish: 'St. Macarius the Great',
  ...
  },
  {
    ...
    nameEnglish: 'St. Paul the First Hermit',
  ...
  },
  {
    ...
    nameEnglish: 'St. Moses the Black',
  ...
  },
  {
    ...
    nameEnglish: 'St. John Chrysostom',
  ...
  },
  {
    ...
    nameEnglish: 'St. Basil the Great',
  ...
  },
  {
    ...
    nameEnglish: 'St. Athanasius the Apostolic',
...
// Helper function to get father by name
export const getFatherByName = (name: string): Father | undefined => {
  return fathers.find(father => father.name === name || father.nameEnglish === name);
};

// Helper function to get father by ID
export const getFatherById = (id: number): Father | undefined => {
